...
class Login {
			...
			if(array_key_exists($doing, self::getSocialServices(['get' => 'all']))) {
				...
				switch($doing) {
					case 'facebook':
						...
						$redirect = $facebook->getLogoutUrl();
						$facebook->destroySession();
						//G\redirect($redirect); // That actually logs out from Facebook.com
					break;
				}
			}
	...
	private static function passwordDB($action, $id, $password, $update_session) {
