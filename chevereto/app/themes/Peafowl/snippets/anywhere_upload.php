        	...
        	<div class="upload-box-heading">
				<div class="upload-box-status">
					<div data-group="upload">
						...
						<div class="heading phone-hide phablet-hide"><a data-trigger="anywhere-upload-input"><?php _se('Drag and drop images here to upload'); ?></a></div>
	...
	<div class="hidden">
		<div id="anywhere-upload-item-template">
			<li class="queue-item">
				...
				<div class="cancel hover-display" data-action="cancel" title="<?php _se('Remove'); ?>">
		...
		<div id="anywhere-upload-edit-item">
			...
			<div class="modal-form">
				...
				<div class="input-label">
					...
					<input type="text" id="form-image-title" name="form-image-title" class="text-input" value="" maxlength="<?php echo CHV\getSetting('image_title_max_length'); ?>">
				</div>
				...
				<div class="input-label">
					...
					<textarea id="form-image-description" name="form-image-description" class="text-input no-resize" placeholder="<?php _se('Brief description of this image'); ?>"></textarea>
				</div>
			</div>
		</div>
