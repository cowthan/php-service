...
<div id="maintenance-wrapper" style="background-image: url(<?php echo CHV\get_system_image_url(CHV\getSetting('maintenance_image')); ?>);">
	<div id="maintenance-content" class="c16 center-box">
