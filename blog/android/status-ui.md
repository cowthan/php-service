...
github地址：https://github.com/cowthan/StatusUI
...
private void initStatusUI(){
    ...
    statusUIManager.addStatusProvider(DefaultStatus.STATUS_LOADING,
    ...
    statusUIManager.addStatusProvider(DefaultStatus.STATUS_EMPTY,
    ...
    statusUIManager.addStatusProvider(DefaultStatus.STATUS_LOGIC_FAIL,
    ...
    statusUIManager.addStatusProvider(DefaultStatus.STATUS_NETOFF,
    ...
    statusUIManager.addStatusProvider(DefaultStatus.STATUS_lOCAL_ERROR,
