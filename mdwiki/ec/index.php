...
<input name="show" type="hidden" value="quickref" />
  ...
  <input name="pattern" type="text" id="pattern" size="30" />&nbsp; <input name="submit" type="submit" value="Search PHP.NET ..." />
    ...
    <div style="margin:5px 0;">PHP Code Here:</div>
        <table width="400px" border="0" cellspacing="1" cellpadding="1" id="console-table">
          <tr>
            <td width="8%" align="right" valign="top"><div class="courier smaller"></div></td>
            <td width="84%" align="center" valign="middle">
                <textarea name="php_input" cols="50" rows="15"
                ><?php echo @$_POST['php_input']; ?></textarea></td>
